    ...
    return room && (
        <div className='py-28 md:py-35 px-4 md:px-16 lg:px-16 lg:px-24 xl:px-32'>
         ...
         <div className='flex flex-col'>
            ...
            <div className='flex flex-wrap items-cemter mt-3 mb-6 gap-4'>
         ...
         <form className='flex flex-col md:flex-row items-start md:items-center justify-between bg-white shadow-[0px_0px_20px-rgba(0,0,0,0.15)] p-6 rounded-xl mx-auto mt-16 max-w-6xl'>
            <div className='flex flex-col flex-wrap md:flex-row items-start md:items-center gap-4 md:gap-10 text-gray-500'>
             ...
             <div className='flex flex-col'>
                ...
                <input type = "date" id='checkOutdate' placeholder = 'Check-In' className='w-full rounded border border-gray-300 py-2 px-3 mt-1.5 outline-none'required />
             </div>
              <div className='w-px h-15 bg-gray-300/70 max-md:hidden'></div>
             <div className='flex flex-col'>
         ...
         <div className='max-w-3xl border-y border-gray-300 my-15 py-10 text-gray-500'>
            <p> Guest will be allocated on the ground floor according to availability. you get a comfortable two bedroom apartment has a true city feeling .The price quoted is for two guest , at the guest slot please mark the number of guests to get the exact price for groups. Room features, amenities, and prices are subject to availability and may change without prior notice. Please confirm all details before booking.
 </p>
         </div>
