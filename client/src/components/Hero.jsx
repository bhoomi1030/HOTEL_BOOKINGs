...
const Hero = () => {
    return (
        <div className = 'flex flex-col items-start justify-center px-6 md:px-16 lg:px-24 xl:px-32 text-white bg-[url("/src/assets/heroImage.png")] bg-no-repeat bg-cover bg-center h-screen'>
            <p className = 'bg-[#99B9FF]/50 px-3.5 py-1 rounded-full mt-20'> The Ultimate Hotel Experience</p>
        ...
        <form className='bg-white text-gray-500 rounded-lg px-6 py-4 mt-5 flex flex-col md:flex-row max-md:items-start gap-4 max-md:mx-auto'>
            ...
            <div>
                <div className='flex items-center gap-2'>
                    <img src={assets.calenderIcon} alt="" classsRoom = 'h-4 '/>
            ...
            <button className='flex items-center justify-center gap-1 rounded-md bg-black py-3 px-4 text-white my-auto cursor-pointer max-md:w-full max-md:py-1' >
                    <img src={assets.searchIcon} alt="search" classsRoom = 'h-7 '/>
                <span>Search</span>
            </button>
        </form>
            </div>
